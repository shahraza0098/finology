...
//       try {
//         const response = await axios.get(`/api/admin/business/${businessId}/complete-registration/add-staffs`);
...
//       <h1>Click to add new member</h1>
//       <div>
//         {teamMembers.map((member) => (
//           <div key={member.id} className="mb-2 p-4 border rounded-lg shadow-sm w-64">
//             <h2 className="text-lg font-semibold">{member.name}</h2>
//             <p className="text-sm text-gray-600">{member.title}</p>
//             <p className="text-sm text-gray-800 mt-2">{member.bio}</p>
//           </div>
//         ))}
//         <Button className="w-32 h-32 rounded-full  bg-gray-200" onClick={() => setOpen(true)}>
