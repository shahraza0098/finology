...
//     { name: "Portfolio", href: "/investor-dashboard/portfolio", icon: PieChart },
//     { name: "Transaction", href: "/investor-dashboard/transaction", icon: CreditCard },
//     { name: "Growth Plan", href: "/investor-dashboard/investment-plan", icon: TrendingUp },
...
//             const active = item.href===pathname?true:false;
//             return (
//               <Link
//                 key={item.href}
//                 href={item.href}
