...
// export default function AchievementsSection({ business }) {
//   return (
//       <section id="achievements" className="grid md:grid-cols-2 gap-4">
...
const AchievementsSection = ({business}) => {
  return (
    <StyledWrapper>
       <section id="achievements">
        <h1 className='text-center text-xl font-bold mb-4'>Achievements</h1>
      <div className="card">
